            ...
            <footer class="page-footer light-blue darken-3">
               <div class="container">
                  <div class="row">
                     <div class="col l6 s12">
                        ...
                        <p class="grey-text text-lighten-4">Jl.Halmahera No. 14 Ds.Kaliwungu , Jombang<br /><i class="fa fa-phone-square"></i> 085X-XXXX-X355</p>
                     </div>
               ...
               <div class="footer-copyright">
                  <div class="container">
                     ...
                     <span class="grey-text text-lighten-4 right">Develope By <a class="blue-text text-lighten-4" href="https://www.facebook.com/Jakdev28">Qomaruddin Rozzaq</a></span>
                  </div>
               </div>
            </footer>
         </div>
